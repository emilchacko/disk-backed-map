...
import com.alok.fbmap.Configuration;
...
public abstract class BaseDiskIO implements DiskIO {
    ...
    @Override
    public abstract void update(Record oldRecord);

    public void doUpdate(Record oldRecord) throws IOException {
        long currentLocation = writer().getFilePointer();
        writer().seek(oldRecord.getLocation());
        oldRecord.write(writer());
